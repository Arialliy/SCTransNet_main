#!/usr/bin/env python3
"""Persist one source-bound TPD-Clean-v5 preflight report."""
...
from experiments.smoke_tpd_clean_v5 import run_smoke  # noqa: E402
from model.tpd_clean_v5 import SUPPORTED_CLEAN_V5_VARIANTS  # noqa: E402


MODEL_SOURCE = REPO_ROOT / "model/tpd_clean_v5.py"
TRAIN_SOURCE = REPO_ROOT / "experiments/train_tpd_clean_v5.py"
SMOKE_SOURCE = REPO_ROOT / "experiments/smoke_tpd_clean_v5.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Persist a TPD-Clean-v5 CPU or CUDA smoke report"
    )
    parser.add_argument(
        "--variant",
...
def main() -> None:
    ...
    envelope = {
        "schema": "sctransnet_tpd_clean_v5_persisted_smoke_v1",
        "status": "complete",
        ...
        "train_source_sha256": _sha256(TRAIN_SOURCE),
