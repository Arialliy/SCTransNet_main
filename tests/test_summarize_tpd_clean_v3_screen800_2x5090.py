...
from experiments import summarize_tpd_clean_v3_screen800_2x5090 as summary
...
def _write_candidate_run(
    ...
    run_dir = (
        ...
        / "NUDT-SIRST"
        / variant
        / f"seed_{seed}_screen800_pd_fp32_shared2x5090_v1"
    )
...
class TPDV3TwoGPUSummaryTests(unittest.TestCase):
    def test_two_gpu_candidate_scope_preserves_seven_gates(self) -> None:
        self.assertEqual(
            summary.DEFAULT_CANDIDATE_ROOT.name,
            "tpd_clean_v3_screen800_2x5090_v1",
        )
        self.assertEqual(
            summary.RUN_TAG, "screen800_pd_fp32_shared2x5090_v1"
        )
