...
from experiments import evaluate_tpd_clean_v6_pd_fa as evaluator


class TPDCleanV6ClosedIntervalSweepTests(unittest.TestCase):
    ...
    def test_main_binds_v6_builder_variants_and_wrapper_source(self) -> None:
        self.assertEqual(
            evaluator.SUPPORTED_CLEAN_V6_VARIANTS,
            (
                "tpd_clean_v6_full",
        ...
        try:
            ...
            self.assertIs(observed["builder"], evaluator.build_clean_v6_model)
